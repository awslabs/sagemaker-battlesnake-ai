...
'''
    ...
    input_signature = {}
    input_signature["observations"] = tf.compat.v1.saved_model.utils.build_tensor_info(policy.observations)

    output_signature = {}
    output_signature["actions"] = tf.compat.v1.saved_model.utils.build_tensor_info(policy.sampler)
    output_signature["logits"] = tf.compat.v1.saved_model.utils.build_tensor_info(policy.logits)
